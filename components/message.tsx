          ...
          if (part.type === "tool-invocation") {
            ...
            return (
              <div key={`${message.id}-${index}`} className="group/message w-full" data-role={message.role}>
                ...
                >
                  {message.role === "user" ? (
                    <div className="ml-4 rounded-[16px] px-4 py-2 md:ml-24 bg-[#ededed] text-stone-900 font-light dark:bg-[#2F302F] dark:text-white">
        ...
        {message.role === "user" ? (
          ...
          <div className="max-w-prose">
            <div className="flex items-baseline gap-2">
              <Markdown>{message.content}</Markdown>
              {props.status === "streaming" && props.isLatestMessage && (
